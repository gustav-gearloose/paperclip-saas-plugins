        ...
        properties: {
          ...
          lines: {
            ...
            items: {
              ...
              properties: {
                product_id: { type: "string", description: "Billy product ID (optional)." },
                ...
                account_id: { type: "string", description: "Billy account ID for this line (optional)." },
                tax_rate_id: { type: "string", description: "Billy tax rate ID, e.g. for 25% VAT (optional)." },
              },
            },
          },
        },
